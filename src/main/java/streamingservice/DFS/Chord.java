 ...
 * DFS.Chord implements DFS.Chord P2P
 *
...
/**
 * DFS.Chord extends from UnicastRemoteObject to support RMI.
 * It implements the DFS.ChordMessageInterface
 *
 */
public class Chord extends java.rmi.server.UnicastRemoteObject implements ChordMessageInterface
{
    ...
    public Chord(int port, long guid) throws RemoteException {
        ...
        prefix = guid + FILE_SEPARATOR + "repository" + FILE_SEPARATOR;
        ...
        try{
            ...
            registry.rebind("DFS.Chord", this);
        }
     ...
     * <p>
     * return the DFS.Chord Interface of the predecessor
     */
     ...
     * <p>
     * @param key
     * return the DFS.Chord Interface of the successor of key
     */
     ...
     * <p>
     * @param key
     * return the DFS.Chord Interface of the closet preceding node
     */
    ...
    public void joinRing(String ip, int port)  throws RemoteException {
        try{
            ...
            ChordMessageInterface chord = (ChordMessageInterface)(registry.lookup("DFS.Chord"));
            predecessor = null;
    ...
    /**
     * It joins the ring in the peer DFS.ChordMessageInterface. The peer must exist
     * <p>
